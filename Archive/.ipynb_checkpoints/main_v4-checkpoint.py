...
class SupplyChainApp:
    ...
    def create_widgets(self):
        ...
        ttk.Button(products_frame, text="Remove Selected Product", 
                  command=self.remove_product).grid(row=4, column=0, columnspan=2, padx=10, pady=2)
        ...
        ttk.Button(dist_frame, text="Remove Selected Distributor", 
                  command=self.remove_distributor).grid(row=5, column=0, columnspan=2, padx=10, pady=2)
